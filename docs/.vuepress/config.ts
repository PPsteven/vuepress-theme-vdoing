...
import nav from './config/nav' // 导入导航栏

const DOMAIN_NAME = 'ppsteven.github.io' // 域名 (不带https)
...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  locales: {
    '/': {
      lang: 'zh-CN',
      title: "软微9133",
      description: 'PPsteven 的个人技术博客，不定时更新，全力coding中',
    }
  },
  ...
  themeConfig: {
    ...
    repo: 'PPsteven/vuepress-theme-vdoing', // 导航栏右侧生成Github链接
    ...
    author: {
      name: 'ppsteven', // 必需
      link: 'https://github.com/ppsteven' // 可选的
    },

    // 博主信息 (显示在首页侧边栏)
    blogger: {
      avatar: 'https://cdn.jsdelivr.net/gh/PPsteven/pictures/img/20201104012528.png',
      name: 'PPsteven',
      slogan: '屁屁斯蒂芬'
    },
      ...
      icons: [
        {
          ...
          title: '发邮件',
          link: 'mailto:ppsteven@outlook.com',
        },
        {
          iconClass: 'icon-github',
          title: 'GitHub',
          link: 'https://github.com/ppsteven'
        },
        {
          iconClass: 'icon-erji',
          title: '听音乐',
          link: 'https://music.163.com/#/playlist?id=119082966'
        },
      ],
    },
    ...
    footer: {
      ...
      copyrightInfo:
        'majutsushi.world All rights reserved | <a href="https://beian.miit.gov.cn" target="_blank" class="text" rel="noreferrer nofollow">沪ICP备2020031729号-1</a>', // 博客版权信息，支持a标签
    },
