...
module.exports = {
  ...
  themeConfig: { // 主题配置
    ...
    repo: 'PPsteven/博客笔记', // 导航栏右侧生成Github链接
    ...
    footer: { // 页脚信息
      ...
      copyrightInfo: 'majutsushi.world All rights reserved | <a href="https://beian.miit.gov.cn" target="_blank" class="text" rel="noreferrer nofollow">沪ICP备2020031729号-1</a>', // 博客版权信息，支持a标签
    }
  },
  plugins: [ // 插件
